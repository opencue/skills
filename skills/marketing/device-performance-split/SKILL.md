...
description: 'Use when user says "mobile vs desktop performance", "device performance split", or "why is mobile cpa so high". Compares mobile, desktop, and tablet; recommends bid adjustments or campaign splits.'
metadata:
