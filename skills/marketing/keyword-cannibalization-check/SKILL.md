...
description: Use when user says "are my keywords competing" or "check keyword cannibalization". Finds duplicate keywords, overlapping match types, and ad groups competing in the same auctions.
metadata:
  platform: Google
category: marketing
---
