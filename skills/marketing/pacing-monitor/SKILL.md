---
name: pacing-monitor
description: 'Use when user says "check my pacing", "am i on budget", or "will i hit my monthly target". Tracks daily spend vs monthly targets and adjustments needed to hit them.'
metadata:
