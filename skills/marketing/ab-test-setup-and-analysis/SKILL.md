...
description: 'Use when user says "set up an a/b test", "design a split test", "calculate sample size", or "can i call a winner yet". Designs valid split tests, sizes them, and calls winners only at significance.'
metadata:
