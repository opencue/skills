...
description: Use when user says "does my page match my ad", "check message match", or "quick landing page check". Checks message match, CTA clarity, above-the-fold alignment, form friction.
metadata:
