...
description: 'Use when user says "build a campaign naming convention", "clean up my campaign names", "fix messy campaign names". Builds a consistent, filterable naming convention across Google and Meta.'
metadata:
