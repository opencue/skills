...
Use this skill when the request maps to programmatic seo and the outcome benefits from a repeatable workflow, concrete artifacts, and explicit verification.
