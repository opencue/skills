...
description: 'Use when user says "is my cpa good", "benchmark my metrics", or "how do i compare to industry". Compares your metrics against industry benchmarks by vertical, campaign type, and platform.'
metadata:
