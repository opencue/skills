...
description: 'Use when user says "what if I increase my budget", "model a budget change", "should I scale spend", "budget scenario". Models CPA, ROAS, conversion volume, and impression share at any budget level.'
metadata:
