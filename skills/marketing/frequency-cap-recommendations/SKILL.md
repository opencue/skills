...
description: 'Use when user says "set a frequency cap", "am i overserving ads", or "audience saturation". Finds where Meta campaigns overserve ads and recommends frequency caps by objective.'
metadata:
  platform: Meta
category: marketing
---
