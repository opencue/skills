...
description: 'Use when user says "write an email sequence", "welcome email series", or "drip campaign emails". Writes nurture sequences with subject lines, preview text, and body copy from your ICP.'
metadata:
