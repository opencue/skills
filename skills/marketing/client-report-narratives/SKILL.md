...
description: 'Use when user says "write the client report summary", "write an executive summary", "explain results to the client". Turns raw campaign data into the plain-English summary at the top of the report.'
metadata:
