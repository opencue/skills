...
version: "1.0.0"
description: Use when the user wants a 9:16 UGC-style video ad from a person photo, product photo, and optional script — builds a lifestyle hero image, then animates it with native spoken audio.
