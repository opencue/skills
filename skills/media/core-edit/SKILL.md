...
version: 0.1.0
description: Use when the user wants to edit or enhance images and videos with AI via muapi.ai — prompt-based editing, upscaling, background removal, face swap, lipsync, video effects, and more
category: media
---
