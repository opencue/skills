...
Use this skill when the request maps to parallel agent dispatching and the outcome benefits from a repeatable workflow, concrete artifacts, and explicit verification.
