...
name: ralplan
description: >-
  [OMX] Use when user says "ralplan", "$ralplan", "plan this", or "PRD for". Planner/Architect/Critic consensus with RALPLAN-DR, ADR, pre-mortem, test spec. NOT for implementing code.
---
