...
Use this skill when the request maps to keybindings & developer ux and the outcome benefits from a repeatable workflow, concrete artifacts, and explicit verification.
