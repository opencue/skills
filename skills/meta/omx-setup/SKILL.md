...
name: omx-setup
description: >-
  [OMX] Use when user says "install omx", "omx setup", or "refresh oh-my-codex". Runs `omx setup [--force|--merge-agents|--scope|--plugin|--legacy]`. NOT for diagnosing — use $doctor.
---
