...
name: cuopt-install
version: "26.08.00"
description: Use when the user wants to install or verify cuOpt for Python, C, or as a server (pip, conda, Docker) — requirements, install commands, verification. For building from source, see cuopt-developer.
category: nvidia
---
# cuOpt Install (user)
