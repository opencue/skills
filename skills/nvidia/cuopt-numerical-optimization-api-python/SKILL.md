...
version: "26.08.00"
description: Use when the user asks to solve LP, MILP, or QP problems with the Python API — linear or quadratic objectives, linear constraints, integer variables, scheduling, or resource allocation.
category: nvidia
---
