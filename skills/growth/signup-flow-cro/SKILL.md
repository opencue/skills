...
Use this skill when the request maps to signup flow cro and the outcome benefits from a repeatable workflow, concrete artifacts, and explicit verification.
