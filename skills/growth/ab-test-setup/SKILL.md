...
Use this skill when the request maps to a/b test setup and the outcome benefits from a repeatable workflow, concrete artifacts, and explicit verification.
