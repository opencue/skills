...
Use this skill when the request maps to paywall & upgrade cro and the outcome benefits from a repeatable workflow, concrete artifacts, and explicit verification.
