...
Use this skill when the request maps to referral program design and the outcome benefits from a repeatable workflow, concrete artifacts, and explicit verification.
